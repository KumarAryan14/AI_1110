...
\subsection*{(i) P(A and B)}
\subsection*{(ii) P(A and not B)}
\subsection*{(iii) P(A or B)}
\subsection*{(iv) P(neither A nor B)}
\section*{Solution :} 
...
= 0.18
\subsection*{(ii) P(A and not B)}
P(A and not B) = P($A \cap B'$) = P(A) - P($A \cap B$)\\
= 0.3 - 0.18
= 0.12
\subsection*{(iii) P(A or B)}
P(A or B) = P($A \cup B$)\\
