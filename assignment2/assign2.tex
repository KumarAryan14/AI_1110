...
\textbf{Solution : }Define random variable $X_{i}$ such that
\begin{align}
	X_{i} &=
	\begin{cases}
...
and
\begin{align}
	P_{X_{i}}(1) &= \frac{1}{10 -i}\\
	P_{X_{i}}(0) &= 1-\frac{1}{10 - i}\\
	&= \frac{9 - i}{10 - i}
\end{align}
Let E be event of getting the right sequence. Since $X_{i}$ are independent of each other, hence
\begin{align}
	\pr{E} &= \prod\limits_{i=0}^{3} P_{X_{i}}(1)\\
	&= P_{X_{0}}(1) \times P_{X_{1}}(1) \times P_{X_{2}}(1) \times P_{X_{3}}(1)\nonumber\\
